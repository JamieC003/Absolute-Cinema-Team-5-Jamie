# Absolute-Cinema-Team-5-Jamie
A self save version of the Absolute Cinema project from SWE class, contains some modifications and improvements. Currently still working on cleaning up some files. The following is the original README.md from the group project.
